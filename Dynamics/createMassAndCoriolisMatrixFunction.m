function [HFunction,HDotFunction,CFunction, env_var_flag]= createMassAndCoriolisMatrixFunction(robotURDFModel,generate_c_code,location_generated_fucntion)
...
[smds, model, env_var] = extractSystemModel(robotURDFModel);
...
if(isempty(env_var))
    ...
    HFunction = Function('computeMassMatrix',{q,env_var},{H},...
                    {'joints_position','env_variables'},...
                    {'massMatrix'});
    HDotFunction = Function('computeMassMatrixTimeDerivative',{q,qd,env_var},{HDot},...
                        {'joints_position','joints_velocity','env_variables'},...
                        {'massMatrixDot'});
    CFunction = Function('computeCoriolisMatrix',{q,qd,env_var},{C},...
                        {'joints_position','joints_velocity','env_variables'},...
                        {'coriolisMatrix'});  
    env_var_flag = 1;
end
